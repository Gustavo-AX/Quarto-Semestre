...
public class XGrafo {
    ...
    public static class Aresta {
        ...
        private int v1, v2, peso; //a aresta agora carrega peso e tempo
    ...
    public int mat[][]; // pesos do tipo inteiro
    ...
    public void insereArestaDirecionada(int v1, int v2, int peso) {
...
// null se a lista de adjacência de v estiver no fim
    ...
    public void insereAresta(int a, int b, int peso) {
        this.insereArestaDirecionada(a, b, peso);
        this.insereArestaDirecionada(b, a, peso);
    }
